...
<div class="navbar-top">
    ...
    <div class="site-brand">
        <a href="/user/index"><h1>Mstore</h1></a>
    </div>
    <!-- end site brand	 -->
...
<div class="navbar-bottom">
    <div class="row">
        <div class="col s2">
            <a href="/user/index"><i class="fa fa-home"></i></a>
        </div>
        <div class="col s2">
...
<div class="menus" id="animatedModal2">
    ...
    <div class="modal-content">
        <div class="container">
            <div class="row">
                <div class="col s4">
                    <a href="/user/index" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
            ...
            <div class="row">
                ...
                <div class="col s4">
                    <a href="/user/car" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
            ...
            <div class="row">
                ...
                <div class="col s4">
                    <a href="{{url("/user/reg")}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
...
<script src="/admin/js/fakeLoader.min.js"></script>
<script src="/admin/js/animatedModal.min.js"></script>
